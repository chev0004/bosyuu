	...
	const Profile = () => {
		...
		return (
			<>
				...
				<div
					key={victim.userid}
					className={`w-[700px] h-[600px] bg-darkMain rounded-xl text-white overflow-hidden fixed z-50 inset-x-0 mx-auto inset-y-0 my-auto transition-all duration-400 ${
